...
-- -- Check if Neovim was opened to the home screen (no arguments)
-- M.isHome = function()
-- 	-- Did the user pass any arguments?
-- 	local has_args = vim.fn.argc() > 0
--
-- 	-- Does the current buffer has any name?
-- 	local has_name = vim.api.nvim_buf_get_name(0) ~= ""
--
-- 	-- Does the current buffer has any custom text? (Redundancy check)
-- 	-- local is_empty = vim.api.nvim_buf_get_var(0, "changedtick") <= 2
-- 	-- 	and vim.api.nvim_buf_line_count(0) == 1
-- 	-- 	and vim.api.nvim_buf_get_lines(0, 0, 1, false)[0] == ""
--
-- 	return not has_args and not has_name
-- 	-- return not has_args and not has_name and is_empty
-- end
