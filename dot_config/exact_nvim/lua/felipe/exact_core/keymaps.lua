...
vim.keymap.set("n", "<M-h>", ":TmuxNavigateLeft<cr>", { desc = "Move focus to the left split", silent = true })
vim.keymap.set("n", "<M-j>", ":TmuxNavigateDown<cr>", { desc = "Move focus to the lower split", silent = true })
vim.keymap.set("n", "<M-k>", ":TmuxNavigateUp<cr>", { desc = "Move focus to the upper split", silent = true })
vim.keymap.set("n", "<M-l>", ":TmuxNavigateRight<cr>", { desc = "Move focus to the right split", silent = true })
vim.keymap.set("n", "<M-\\>", ":TmuxNavigatePrevious<cr>", { desc = "Move focus to the previous split", silent = true })
