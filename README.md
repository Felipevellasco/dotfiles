...
On Linux:
```bash
sh -c "$(curl -fsSL https://raw.githubusercontent.com/Felipevellasco/dotfiles/main/.install.sh)"
```

On Windows:
```bash
powershell -c "irm https://raw.githubusercontent.com/Felipevellasco/dotfiles/main/.install.ps1 | iex"
```
